...
Xena Python RFC Core allows users to subscribe to different messages generated by different test suites and subsystems (ResourcesManager, ExecutorManager), so you can get test statistics/results, monitor test progress, receiver errors and warnings, etc.

Message Subscription
--------------------

Xena Python RFC Core provide two types of messages for you to subscribe to:
